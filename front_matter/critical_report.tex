...
\repository{edition-esser-skala/}
\version{1.0.0}
\date{2021-11-01}
\maketitle
...
\raisebox{-4mm}{\includegraphics{byncsaeu}}\hspace*{1em}Edition Esser-Skala, \DTMfetchyear{compiled}

© \DTMfetchyear{compiled} by Edition Esser-Skala. This edition is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. To view a copy of this license, visit \url{https://creativecommons.org/licenses/by-nc-sa/4.0/}.

Music engraving by LilyPond 2.22.1 (\url{https://www.lilypond.org}).\\
